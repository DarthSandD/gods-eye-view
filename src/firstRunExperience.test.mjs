...
test('the voice TOOL SCHEMA is byte-identical to main — the mission mapping is instructions only', () => {
  ...
  assert.equal(block.length, 31192, 'tool schema byte length drifted from the pinned release schema');
  assert.equal(
    crypto.createHash('sha256').update(block).digest('hex'),
    '7036ea8648c13cabced7bb5c025c0334d8ec2dda7370c8a20174dbca3312ece3',
